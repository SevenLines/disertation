...
\vspace{30mm}
\begin{center}
{\Large\bfКаташевцев Михаил Дмитриевич}
\end{center}
...
\thispagestyle{empty}
\noindent Работа выполнена ИГУ ИМЭИ

\begin{table} [h]  
  \begin{tabular}{ll}  
   \makecell[l]{\sfs Научный руководитель:\\~} &
   \makecell*[{{p{11cm}}}]{\sfs
   доктор физико-математических наук, профессор \\ \textbf{\sfs Мартьянов Владимир Иванович}}
...
\vspace{3mm} \\
   ...
   \makecell*[{{p{11cm}}}]{\sfs
   Федеральное государственное бюджетное образовательное учреждение высшего профессионального образования иркутский государственный университет институт математики экономики и информатики
   }
  \end{tabular}  
\end{table}
